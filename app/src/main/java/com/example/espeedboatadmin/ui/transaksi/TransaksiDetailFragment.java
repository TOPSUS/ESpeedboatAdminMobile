...
public class TransaksiDetailFragment extends Fragment {
    ...
    private void getData() {
        Call<Response> getDetail = service.getTransaksiDetail(new SessionManager().getAuthToken(), this.transaksi_id);
        ...
        this.btn_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isDone == 0) {
                    ...
                    Call<Response> approveTransaksi = service.approveTransaksi(new SessionManager().getAuthToken(), transaksi_id);
